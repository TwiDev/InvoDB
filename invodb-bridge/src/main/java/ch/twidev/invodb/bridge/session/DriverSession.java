...
public interface DriverSession<Session> extends Closeable {
    ...
    OperationResult delete(DeleteContext updateContext, PlaceholderContext placeholderContext);
    CompletableFuture<OperationResult> deleteAsync(DeleteContext updateContext, PlaceholderContext placeholderContext);
